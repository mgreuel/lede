...
- What the index leaves out — a veto rule of yours, a grade of nought, or a grade under the lowest one you asked to see — is out of the list but never dropped. **Show what the index leaves out** in the rail says how many there are and puts them at the foot of the list, so a rule that matches too much, or a line drawn too high, is something you can find and fix.
